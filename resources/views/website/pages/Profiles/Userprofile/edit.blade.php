...
<div class="form-group mb-3">
    ...
    @if ($profileUser->image)
        <div class="mb-2">
            <img src="{{ asset('storage/' . $profileUser->image) }}" alt="Current Image" style="max-width: 200px; height: auto;">
        </div>
    @endif
...
<div class="form-group mb-3">
    ...
    <select name="membership" id="membership" 
        ...
        <option value="Silver" {{ $profileUser->membership === "Silver" ? "selected" : '' }}>Silver</option>
        <option value="Gold" {{ $profileUser->membership === "Gold" ? "selected" : '' }}>Gold</option>
        <option value="Platinum" {{ $profileUser->membership === "Platinum" ? "selected" : '' }}>Platinum</option>
    </select>
    @error('membership')
        <span class="invalid-feedback" role="alert">
            <strong class="text-danger">{{ $message }}</strong>
...
<div class="form-group mb-3">
    ...
    <input type="number" name="body_fats_percentage" id="body_fats_percentage" 
           value="{{ old('body_fats_percentage', $profileUser->body_fats_percentage ?? 0) }}" 
...
<div class="form-group mb-3">
    ...
    <input type="number" name="muscle_mass_percentage" id="muscle_mass_percentage" 
           value="{{ old('muscle_mass_percentage', $profileUser->muscle_mass_percentage ?? 0) }}" 
...
<div class="form-group mb-3">
    ...
    <input type="number" name="water_percentage" id="water_percentage" 
           value="{{ old('water_percentage', $profileUser->water_percentage ?? 0) }}" 
...
<div class="form-group mb-3">
    ...
    <input type="number" name="bone_mass_percentage" id="bone_mass_percentage" 
           value="{{ old('bone_mass_percentage', $profileUser->bone_mass_percentage ?? 0) }}" 
...
<div class="form-group mb-3">
    ...
    <input type="number" name="other_composition_percentage" id="other_composition_percentage" 
           value="{{ old('other_composition_percentage', $profileUser->other_composition_percentage ?? 0) }}" 
...
<div class="form-group mb-3">
    ...
    <input type="number" name="cardio_percentage" id="cardio_percentage" 
           value="{{ old('cardio_percentage', $profileUser->cardio_percentage ?? 0) }}" 
...
<div class="form-group mb-3">
    ...
    <input type="number" name="daily_goal_percentage" id="daily_goal_percentage" 
           value="{{ old('daily_goal_percentage', $profileUser->daily_goal_percentage ?? 0) }}" 
...
<div class="form-group mb-3">
    ...
    <input type="number" name="calories_percentage" id="calories_percentage" 
           value="{{ old('calories_percentage', $profileUser->calories_percentage ?? 0) }}" 
...
<div class="form-group mb-3">
    ...
    <input type="number" name="plan_progress_percentage" id="plan_progress_percentage" 
           value="{{ old('plan_progress_percentage', $profileUser->plan_progress_percentage ?? 0) }}" 
